...
public class frmEmpleados extends javax.swing.JFrame {
    ...
    public frmEmpleados() {
        ...
        String[] titulos= {"ID","Nombre","Apellido","Correo","Cargo","Área"};
    ...
    private void initComponents() {
        ...
        tblEmpleados.setBackground(new java.awt.Color(255, 204, 204));
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        ...
        String strSentenciaInsert= String.format("INSERT INTO Empleados (ID, Nombre, Apellido, Correo, Cargo, Área)"
                + "VALUES (null, '%s','%s','%s','%s','%s')", oEmpleados.getNombre(), oEmpleados.getApellido(), oEmpleados.getCorreo(), oEmpleados.getCargo(), oEmpleados.getArea());
    ...
    private void tblEmpleadosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblEmpleadosMouseClicked
        ...
        if(evt.getClickCount()==1){
            ...
            txtCargo.setText(receptor.getModel().getValueAt(receptor.getSelectedRow(), 4).toString());
            txtArea.setText(receptor.getModel().getValueAt(receptor.getSelectedRow(), 5).toString());
        }
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        ...
        String strSentenciaEdit= String.format("UPDATE Empleados SET Nombre='%s',"
                + " Apellido='%s', Correo='%s' , Cargo='%s', Área='%s'  WHERE ID = %d", oEmpleados.getNombre(),oEmpleados.getApellido(), oEmpleados.getCorreo(),oEmpleados.getCargo(), oEmpleados.getArea(), oEmpleados.getID());
    ...
    public void mostrarDatos(){
        ...
        try {
            ...
            while (resultado.next()) {
                ...
                System.out.println(resultado.getString("Área"));
                
                Object[] oUsuario={resultado.getString("ID"),resultado.getString("Nombre"),resultado.getString("Apellido"),resultado.getString("Correo"),resultado.getString("Cargo"),resultado.getString("Área")};
    ...
    public empleadosBL recuperarDatosGUI(){
        ...
        oEmpleados.setArea(txtArea.getText());
